...
int qrencode_tmain_bmp(int argc, _TCHAR ** argv)
{
    ...
    unsigned int    unWidth = 0, x = 0, y = 0, l = 0, n = 0, unWidthAdjusted = 0, unDataBytes = 0;
    unsigned char*  pRGBData = 0, *pSourceData = 0, *pDestData = 0;
    QRcode*         pQRC = 0;
    FILE*           f = 0;
    ...
    if (pQRC = QRcode_encodeString(szSourceSring, 0, QR_ECLEVEL_H, QR_MODE_8, 1))
    {
        ...
        bfh.bfSize = sizeof(BITMAPFILEHEADER) + sizeof(BITMAPINFOHEADER) + unDataBytes;
        bfh.bfReserved1 = 0;
        bfh.bfReserved2 = 0;
        ...
        bih.biWidth = unWidth * OUT_FILE_PIXEL_PRESCALER;
        bih.biHeight = -((int)unWidth * OUT_FILE_PIXEL_PRESCALER);
        bih.biPlanes = 1;
        bih.biBitCount = 24;
        ...
        // Free data
        free(pRGBData);pRGBData = 0;
        QRcode_free(pQRC);pQRC = 0;
    }
    else
    {
